...
import worker from "/mnt/dev/ideashare/ideashare-userfront/.wrangler/tmp/bundle-dbW9rG/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/mnt/dev/ideashare/ideashare-userfront/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/mnt/dev/ideashare/ideashare-userfront/.wrangler/tmp/bundle-dbW9rG/middleware-insertion-facade.js";
